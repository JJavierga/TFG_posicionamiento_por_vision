...
Mat Prev_rot_matrix=Mat::eye(3,3,CV_64FC1);//Para cálculo rotación más parecida
...
{
	  // Selección del algoritmo ORB con un parámetros por defecto
	...
	Ptr<DescriptorMatcher> matcher=makePtr<FlannBasedMatcher>(cv::makePtr<cv::flann::LshIndexParams>(20, 12, 2));
